const tours = [
  ...
  {
    title: "Абрау-Дюрсо: озеро и винные виды",
    location: "Абрау-Дюрсо",
    distance: "30-45 км",
    pace: "Комфортный",
    summary:
      "Озеро, холмы, красивые дороги и атмосфера южного отдыха. Маршрут, который хорошо смотрится и на сайте, и в соцсетях.",
    features: [
      "Видовые точки",
      "Южная атмосфера",
      "Авторский формат выходного дня"
    ]
  },
  {
  ...
  {
    title: "Горячий Ключ: лесные дороги и воздух предгорий",
    location: "Горячий Ключ",
    distance: "25-40 км",
    pace: "Спокойный",
    summary:
      "Маршрут выходного дня недалеко от Краснодара: лес, подъемы без перегруза и ощущение, что ты быстро выбрался из города в природу.",
    features: [
      "Близко к Краснодару",
      "Лесной маршрут",
      "Хорош для первой группы"
    ]
  },
  {
    ...
    pace: "Комфортный",
    summary:
      "Побережье, можжевеловые пейзажи и сильная визуальная подача. Маршрут, который продает эмоции уже одним названием.",
    features: [
      "Море и природа",
      "Видовой маршрут",
      "Хорош для контента и фото"
    ]
  },
  {
    ...
    pace: "Легкий",
    summary:
      "Утренний городской формат для рекламы и первого касания с проектом: парк без толпы, красивые кадры, мягкий старт и кофе после поездки.",
    features: [
    ...
    <main className="page-shell">
      ...
      <section className="section" id="tours">
        <div className="section__heading">
          ...
          <h2>Первые 6 маршрутов для запуска и продвижения</h2>
          <p className="section__text">
            Здесь уже не заглушки, а стартовая линейка, на которой можно строить
            сайт, рекламу и первые выезды.
          </p>
        </div>
